import { B as dropPoint, F as Plugin, H as Slice, I as PluginKey, L as Selection$1, M as Decoration, N as DecorationSet, P as NodeSelection, R as TextSelection, S as isNodeSelection, V as Fragment, j as keydownHandler, l as createStyleTag, o as callOrReturn, p as getExtensionField, r as Extension, x as isNodeEmpty, z as Mapping } from "./core+[...].mjs";
...
function getViewportBoundaryPositions({ view, scrollContainer }) {
	...
	const targetX = getComputedStyle(view.dom).direction === "rtl" ? editorRect.right - 2 : editorRect.left + 2;
	...
	if (probeTop > probeBottom) return null;
...
function createPlaceholderPlugin({ editor, options }) {
	...
	return new Plugin({
		...
		props: { decorations: ({ doc, selection }) => buildPlaceholderDecorations({
			editor,
			options,
			dataAttribute,
			doc,
...
//#endregion
export { UndoRedo as a, TrailingNode as i, Dropcursor as n, Gapcursor as r, index_default as t };
