import { A as wrappingInputRule, D as parseIndentedBlocks, F as Plugin, O as renderNestedMarkdownContent, T as mergeAttributes, V as Fragment, _ as getRenderedAttributes, a as Node3, b as isNodeActive, g as getNodeType, h as getNodeAtPosition, r as Extension, v as isAtEndOfNode, y as isAtStartOfNode } from "./@tiptap/core+[...].mjs";
...
function isBlockContentLine(line) {
	...
	return /^[-+*]\s+/.test(trimmedLine) || isOrderedListMarkerLine(trimmedLine) || /^>\s?/.test(trimmedLine) || /^```/.test(trimmedLine) || /^~~~/.test(trimmedLine);
}
