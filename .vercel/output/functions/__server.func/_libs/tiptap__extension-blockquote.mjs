...
function nfa(expr) {
	...
	function compile(expr2, from) {
		if (expr2.type == "choice") return expr2.exprs.reduce((out, expr3) => out.concat(compile(expr3, from)), []);
			...
			connect(compile(expr2.expr, loop), loop);
			return [edge(loop)];
		} else if (expr2.type == "opt") return [edge(from)].concat(compile(expr2.expr, from));
			...
			return [edge(cur)];
		} else if (expr2.type == "name") return [edge(from, void 0, expr2.value)];
